<template>
  <div class="ecl-container">
    ...
    <p class="ecl-u-type-paragraph">
      ...
      methodological notes, references and sources. Use the "download" and
    ...
    <p class="ecl-u-type-paragraph">
      ...
      functionalities for human and machine reading of data and metadata. The
      documentation page presents some reports and notes about the technical
      characteristics of the project developing the present visualisation tool
      and semantic repository.
    </p>
  </div>
</template>
